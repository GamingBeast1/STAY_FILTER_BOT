...
SUPPORT_GROUP = environ.get('SUPPORT_GROUP', '-1006039522169')
...
OPENAI_API = environ.get('OPENAI_API', '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')
if len(OPENAI_API) == 0:
...
# Links
SUPPORT_LINK = environ.get('SUPPORT_LINK', 'https://t.me/Galaxy_support123')
...
VERIFY_TUTORIAL = environ.get("VERIFY_TUTORIAL", "https://t.me/+ntInw10a0RgwOWNl")
